 ...
 * 
 *
 * Copyright (c) 2004 FORTHnet, S.A. All Rights Reserved.
 *
 *
 ...
 * @version $Id: PasswordFieldEditor.java 10 2004-11-17 12:30:10Z tuhlmann $
 */
public class PasswordFieldEditor extends FieldEditor {
  ...
  public String getStringValue() {
    ...
    else return getPreferenceStore().getString(getPreferenceName());
  }
  ...
  public void setTextLimit(int limit) {
    textLimit = limit;
    if (textField != null) textField.setTextLimit(limit);
  }
  ...
  protected void valueChanged() {
    ...
    if (isValid != oldState) fireStateChanged(IS_VALID, oldState, isValid);
