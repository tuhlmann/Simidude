...
public interface X11 extends Library {
   ...
   class VisualID extends NativeLong {
       private static final long serialVersionUID = 6193026617691868548L;
       public VisualID() { }
       public VisualID(long value) { super(value); }
   }

   class XID extends NativeLong {
       private static final long serialVersionUID = -6266868873222788404L;
   ...
   class Atom extends XID {
       private static final long serialVersionUID = -6025382529265492148L;
   ...
   class Colormap extends XID {
       private static final long serialVersionUID = -8865724028114796414L;
   ...
   class Font extends XID {
       private static final long serialVersionUID = 7406717014178896866L;
   ...
   class Cursor extends XID {
       private static final long serialVersionUID = 5620711837331314122L;
   ...
   class KeySym extends XID {
       private static final long serialVersionUID = -9097834479465072104L;
   ...
   class Drawable extends XID {
       private static final long serialVersionUID = -1587544291026121638L;
   ...
   class Window extends Drawable {
       private static final long serialVersionUID = 8914937811536206468L;
   ...
   class Pixmap extends Drawable {
       private static final long serialVersionUID = 1255707082854132125L;
   ...
   interface Xrender extends Library {
       ...
       class PictFormat extends NativeLong {
           private static final long serialVersionUID = 1516972470097828137L;
