...
public class SignalGoodByeCommand extends AbstractRemoteCommand {

  private static final long serialVersionUID = 1L;

  private final ClientNode myOwnNode;
  
  public SignalGoodByeCommand(ClientNode myOwnNode)
  {
    this.myOwnNode = myOwnNode;
  }
  ...
  public Object invoke(IConnectorServerHandler connectorServerHandler)
  {
    ...
    remoteConnector.getConnector().shutdownNode(myOwnNode);
    return Boolean.TRUE;
  }
